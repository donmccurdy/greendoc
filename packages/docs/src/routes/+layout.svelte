...
<svelte:head>
	...
	<meta name="og:image" content={$page.url.origin + '/media/hero.jpg'} />
	<meta
		name="og:image:alt"
		content="Function symbol, f(📦) → 📦, where the argument and output are a box labeled 'glTF'."
	/>
	...
	<meta name="twitter:image" content={$page.url.origin + '/media/hero.jpg'} />
	<meta
